...
# MAGIC from bbart_test.llc_bi__account_covenant__c
...
# MAGIC from bbart_test.llc_bi__covenant2__c
...
# MAGIC from bbart_test.llc_bi__covenant_compliance2__c
...
# MAGIC ,FULL_NAME__C
# MAGIC ,CREATEDBYID
# MAGIC from bbart_test.llc_bi__covenant_type__c
...
# MAGIC %sql
# MAGIC create or replace table dga_final.test_bbcrm_account_covenant_base as
...
# MAGIC %sql
# MAGIC select * from dga_final.test_bbcrm_account_covenant_base